    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-7 lg:grid-cols-10 gap-2.5 sm:gap-4">
          {problems.map((p, i) => (
            <motion.div key={p.label} initial={{opacity:0,y:12}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:i*0.04}} className="flex flex-col items-center text-center group">
