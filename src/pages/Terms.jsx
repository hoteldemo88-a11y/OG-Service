...
export default function Terms() {
  return (
    <>
      <SEO title="Terms & Conditions" description="Terms and Conditions for RO Service Center. Read our complete terms of service, pricing policy, warranty, cancellation, and liability terms." url="/terms" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#f8fafc] rounded-2xl p-6 sm:p-8 border border-[#e2e8f0] mb-8 sm:mb-10">
              <p className="text-[#475569] text-sm sm:text-base leading-relaxed">
                Welcome to RO Service Center. These Terms and Conditions govern your use of our website and services. Please read them carefully before booking a service. By engaging our services, you agree to be legally bound by these terms.
              </p>
            </div>
            ...
            <div className="mt-10 sm:mt-12 bg-[#f8fafc] rounded-2xl p-6 sm:p-8 border border-[#e2e8f0]">
              ...
              <p className="text-[#64748b] text-sm leading-relaxed">If you have any questions about these Terms & Conditions, please contact us at <a href="mailto:info@roservicecenter.in" className="text-[#2563eb] hover:underline font-medium">info@roservicecenter.in</a> or call us at <a href="tel:919876543210" className="text-[#2563eb] hover:underline font-medium">+91 98765 43210</a>.</p>
            </div>
          </div>
        </Container>
      </section>
