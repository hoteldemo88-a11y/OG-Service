...
const brandFaqs = {
  ...
  havells: [
    { id: 1, question: 'How often should I service my RO?', answer: 'We recommend servicing your RO every 6-12 months for best performance.' },
    { id: 2, question: 'Do you use genuine parts?', answer: 'Yes, we use only genuine spare parts for all repairs and replacements.' },
    { id: 3, question: 'How long does a service take?', answer: 'Most service visits are completed within 30-45 minutes. Same-day service is available.' },
    { id: 4, question: 'What areas do you cover?', answer: 'We cover all major areas in Bangalore including Koramangala, Whitefield, Electronic City, JP Nagar, and more.' },
    { id: 5, question: 'What is the cost of filter replacement?', answer: 'Filter replacement starts from ₹1,500 depending on the model and filter type required.' },
    { id: 6, question: 'Do you offer AMC plans?', answer: 'Yes, we offer comprehensive Annual Maintenance Contracts for hassle-free maintenance.' },
    { id: 7, question: 'How do I book a service?', answer: 'You can call us directly or fill the booking form on this page. We will call you to confirm the appointment.' },
    { id: 8, question: 'What is the warranty on repair?', answer: 'We provide a 30-day service warranty on all repairs. Part warranty varies by component.' },
  ],
  livpure: [
...
const brandServices = {
  ...
  havells: [
    { title: 'RO Repair', description: 'Expert repair for all Havells water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
  livpure: [
    { title: 'RO Repair', description: 'Expert repair for all Livpure water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
  'zero-b': [
    { title: 'RO Repair', description: 'Expert repair for all Zero B water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
  'aqua-grand': [
    { title: 'RO Repair', description: 'Expert repair for all Aqua Grand water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
  'aqua-pearl': [
    { title: 'RO Repair', description: 'Expert repair for all Aqua Pearl water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
  puresis: [
    { title: 'RO Repair', description: 'Expert repair for all Puresis water purifier models.' },
    { title: 'Filter Change', description: 'Genuine filter replacement for clean and safe water.' },
    { title: 'Membrane Replacement', description: 'RO membrane replacement for optimal purification.' },
    { title: 'AMC Plans', description: 'Annual maintenance contracts for hassle-free service.' },
  ],
      ...
      <section className="relative pt-24 sm:pt-32 pb-12 sm:pb-20 bg-[#f8fafc] overflow-hidden">
        <Container className="relative z-10">
          ...
          <div className="max-w-xl mt-8 sm:mt-10 text-center">
            <h1 className="text-[24px] sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-[#0f172a] leading-[1.1] mb-2 sm:mb-3">Your RO Not Working?<br />We Fix It Today.</h1>
