    ...
    <>
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 bg-[#f8fafc] overflow-hidden">
        <Container className="relative z-10">
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-2xl mt-6 text-center lg:text-left">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#eff6ff] border border-[#bfdbfe] mb-5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
              <span className="text-[12px] font-medium text-[#2563eb]">Since 2014</span>
            </motion.div>
            <motion.h1 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-[#0f172a] leading-[1.1] mb-6 text-center lg:text-left">
              About RO Service Center
            </motion.h1>
            <motion.p variants={fadeUp} className="text-base sm:text-lg text-[#64748b] leading-relaxed text-center lg:text-left">
      ...
      <section className="py-16 sm:py-20 bg-[#f8fafc]">
        <Container>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white p-6 sm:p-8 rounded-2xl border border-[#e2e8f0] text-center lg:text-left">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-white p-6 sm:p-8 rounded-2xl border border-[#e2e8f0] text-center lg:text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
            {values.map((value, i) => {
              ...
              return (
                <motion.div key={value.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-white p-5 sm:p-6 rounded-2xl border border-[#e2e8f0] hover:shadow-lg transition-all text-center lg:text-left">
      ...
      <section className="py-16 sm:py-20 bg-white">
        <Container>
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            {timeline.map((item, i) => (
              <motion.div key={item.year} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="relative flex items-start gap-4 sm:gap-6 mb-8 sm:mb-10">
